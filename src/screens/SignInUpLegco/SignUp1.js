...
// )
  ...
  //   //   //   this.myAlert(response.data.message)
  //   //   // console.log(response.data, 'reeeeeees');
  //   //     if (response.data.message==='Поздравляем! Вы успешно прошли регистрацию в роли Физ. лица.'
  //   //     || response.data.message==='Поздравляем! Вы успешно прошли регистрацию в роли ИП.'){
  //   //         console.log('ua tut')
  //   //         this.myAlert()
  //   // } else {
  //   //   Alert.alert('Что-то пошло не так','ываыва',
