...
class SegmentNB extends Component {
  ...
  const formData = `deal501=${JSON.stringify(this.state.deal501)}&deal_id=${this.state.deal.deal_id}&duedate=${this.state.duedate}&workdeadline=${this.state.workdeadline}&lawid=${this.state.lawid}`
...
componentDidMount() {
  ...
  axios.post('https://sdelkibackend.herokuapp.com/api/getinfodeal',formData, {
      responseType: 'json',
      headers: {
          'Content-type': 'applicsdation/x-www-form-urlencoded'
      }
  })
  .then(res => {
...
<Text style={styles.myFont1}>Сторона 1</Text>
<Item disabled>
  <Input disabled
  multiline={true}
  placeholder={this.state.deal.side1.firstname+ ' '+ this.state.deal.side1.lastname}  />
  <IconNB name="ios-information-circle" />
</Item>
<Text style={styles.myFont1}>Сторона 2</Text>
<Item disabled>
  <Input disabled
  multiline={true}
  placeholder={this.state.deal.side2.firstname+ ' '+ this.state.deal.side2.lastname}  />
    <IconNB name="ios-information-circle" />
</Item>

<Text style={styles.myFont1}>Наименование имущества подлежащего передаче Стороной 1</Text>

  <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
  multiline={true}
   onChangeText={(text) => this.deal501(text, 'itemname1')}
  defaultValue={this.state.deal.itemname1}
  placeholder={this.state.deal.itemname1}  />

<Text style={styles.myFont1}>Количество имущества, подлежащего передаче Стороной 1</Text>

  <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
  multiline={true}
  onChangeText={(text) => this.deal501(text, 'quantity1')}
  defaultValue={this.state.deal.quantity1}
  placeholder={this.state.deal.quantity1}  />

<Text style={styles.myFont1}>Стоимость имущества,  подлежащего передаче Стороной 1</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'price1')}
    defaultValue={this.state.deal.price1}
    placeholder={this.state.deal.price1}  />

<Text style={styles.myFont1}>Качество имущества подлежащего передаче Стороной 1</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'quality1')}
    defaultValue={this.state.deal.quality1}
    placeholder={this.state.deal.quality1}  />

<Text style={styles.myFont1}>Характеристика имущества подлежащего передаче Стороной 1</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'description1')}
    defaultValue={this.state.deal.description1}
    placeholder={this.state.deal.description1}  />

<Text style={styles.myFont1}>Cостояние имущества подлежащего передаче Стороной 1</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'state1')}
    defaultValue={this.state.deal.state1}
    placeholder={this.state.deal.state1}  />




<Text style={styles.myFont1}>Наименование имущества подлежащего передаче Стороной 2</Text>

  <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
  multiline={true}
   onChangeText={(text) => this.deal501(text, 'itemname2')}
  defaultValue={this.state.deal.itemname2}
  placeholder={this.state.deal.itemname2}  />

<Text style={styles.myFont1}>Количество имущества, подлежащего передаче Стороной 2</Text>

  <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
  multiline={true}
  onChangeText={(text) => this.deal501(text, 'quantity2')}
  defaultValue={this.state.deal.quantity2}
  placeholder={this.state.deal.quantity2}  />

<Text style={styles.myFont1}>Стоимость имущества,  подлежащего передаче Стороной 2</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'price2')}
    defaultValue={this.state.deal.price2}
    placeholder={this.state.deal.price2}  />

<Text style={styles.myFont1}>Качество имущества подлежащего передаче Стороной 2</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'quality2')}
    defaultValue={this.state.deal.quality2}
    placeholder={this.state.deal.quality2}  />

<Text style={styles.myFont1}>Характеристика имущества подлежащего передаче Стороной 2</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'description2')}
    defaultValue={this.state.deal.description2}
    placeholder={this.state.deal.description2}  />

<Text style={styles.myFont1}>Cостояние имущества подлежащего передаче Стороной 2</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'state2')}
    defaultValue={this.state.deal.state2}
    placeholder={this.state.deal.state2}  />


<Text style={styles.myFont1}>Сроки и порядок обмена имуществом</Text>

    <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
    multiline={true}
    onChangeText={(text) => this.deal501(text, 'deadline')}
...
<Text style={styles.myFont1}>Дополнительные условия (не обязательное ус-ие)</Text>
  ...
  <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
  multiline={true}
  onChangeText={(text) => this.deal501(text, 'additional')}
  ...
  <Spinner color="blue" />
        ...
        {(Object.keys(this.state.olddeal).length != 0)?(
          ...
          <Item disabled>
            <Input disabled
            multiline={true}
            placeholder={this.state.olddeal.side1.firstname+ ' '+ this.state.olddeal.side1.lastname}  />
            <IconNB name="ios-information-circle" />
          </Item>
          <Text style={styles.myFont1}>Сторона 2</Text>
          <Item disabled>
            <Input disabled
            multiline={true}
            placeholder={this.state.olddeal.side2.firstname+ ' '+ this.state.olddeal.side2.lastname}  />
              <IconNB name="ios-information-circle" />
          </Item>
          ...
          <Item disabled >
            ...
            multiline={true}
            defaultValue={this.state.olddeal.itemname1}
            placeholder={this.state.olddeal.itemname1}  />
            {objKeys.includes("itemname1")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Количество имущества, подлежащего передаче Стороной 1</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.quantity1}
            placeholder={this.state.olddeal.quantity1}  />
            {objKeys.includes("quantity1")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Стоимость имущества,  подлежащего передаче Стороной 1</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.price1}
            placeholder={this.state.olddeal.price1}  />
            {objKeys.includes("price1")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Качество имущества подлежащего передаче Стороной 1</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.quality1}
            placeholder={this.state.olddeal.quality1}  />
            {objKeys.includes("quality1")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Характеристика имущества подлежащего передаче Стороной 1</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.description1}
            placeholder={this.state.olddeal.description1}  />
            {objKeys.includes("description1")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Cостояние имущества подлежащего передаче Стороной 1</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.state1}
            placeholder={this.state.olddeal.state1}  />
            {objKeys.includes("state1")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          ...
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.itemname2}
            placeholder={this.state.olddeal.itemname2}  />
            {objKeys.includes("itemname2")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Количество имущества, подлежащего передаче Стороной 2</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.quantity2}
            placeholder={this.state.olddeal.quantity2}  />
            {objKeys.includes("quantity2")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Стоимость имущества,  подлежащего передаче Стороной 2</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.price2}
            placeholder={this.state.olddeal.price2}  />
            {objKeys.includes("price2")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Качество имущества подлежащего передаче Стороной 2</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.quality2}
            placeholder={this.state.olddeal.quality2}  />
            {objKeys.includes("quality2")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Характеристика имущества подлежащего передаче Стороной 2</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.description2}
            placeholder={this.state.olddeal.description2}  />
            {objKeys.includes("description2")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          <Text style={styles.myFont1}>Cостояние имущества подлежащего передаче Стороной 2</Text>
          <Item disabled >
            <Input disabled={!this.state.toChange}
            multiline={true}
            defaultValue={this.state.olddeal.state2}
            placeholder={this.state.olddeal.state2}  />
            {objKeys.includes("state2")? <IconNB name="md-create" />:<Text></Text>}
          </Item>
          ...
          <Text style={styles.myFont1}>Сроки и порядок обмена имуществом</Text>
            <Item disabled >
              ...
              placeholder={this.state.olddeal.deadline}  />
