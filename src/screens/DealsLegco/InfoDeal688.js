...
<Content>
<H2 style={styles.myFontH}>Договор перевозки</H2>
        ...
        {(Object.keys(this.state.olddeal).length != 0)?(
          ...
          <Text style={styles.myFont1}>Отправитель</Text>
           <Item disabled>
             <Input disabled
             multiline={true}
             placeholder={this.state.olddeal.sender.firstname+ ' '+ this.state.olddeal.sender.lastname}  />
           ...
           <Item disabled>
             <Input disabled
             multiline={true}
             placeholder={this.state.olddeal.сarrier.firstname+ ' '+ this.state.olddeal.сarrier.lastname}  />
           ...
           <Item disabled >
             <Input disabled
             multiline={true}
             defaultValue={this.state.olddeal.transportableproperty}
             placeholder={this.state.olddeal.transportableproperty}  />
           ...
           <Item disabled regular={!this.state.isRegular}>
             <Input disabled
             multiline={true}
             defaultValue={this.state.olddeal.shippingaddress}
             placeholder={this.state.olddeal.shippingaddress}  />
           ...
           <Item disabled regular={!this.state.isRegular}>
             <Input disabled
             multiline={true}
             defaultValue={this.state.olddeal.deliveryaddress}
             placeholder={this.state.olddeal.deliveryaddress}  />
           ...
           <Item disabled regular={!this.state.isRegular}>
             <Input disabled
             multiline={true}
             defaultValue={this.state.olddeal.recipientofproperty}
             placeholder={this.state.olddeal.recipientofproperty}  />
           ...
           <Item disabled >
             <Input disabled
multiline={true}
             placeholder={this.dateFormat(this.state.olddeal.shippingday)}  />
           ...
           <Item disabled >
             <Input disabled
multiline={true}
             defaultValue={this.state.olddeal.shippingprice}
             placeholder={this.state.olddeal.shippingprice}  />
