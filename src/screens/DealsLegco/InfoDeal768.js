...
class SegmentNB extends Component {
  ...
  updateDeal688(){
    const formData = `deal768=${JSON.stringify(this.state.deal1)}&deal_id=${this.state.deal.deal_id}&duedate=${this.state.duedate}&shelfdate=${this.state.shelfdate}`
      ...
      <Content padder>
        {this.state.seg === 1 &&
          ...
          {(Object.keys(this.state.deal).length != 0)?(
            ...
            <H2 style={styles.myFontH}>{this.state.deal.deal_name}</H2>
               ...
               <Text style={styles.myFont1}>Хранитель</Text>
              <Item disabled>
                <Input disabled
                multiline={true}
                placeholder={this.state.deal.keeper.firstname+ ' '+ this.state.deal.keeper.lastname}  />
                <IconNB name="ios-information-circle" />
              </Item>
              <Text style={styles.myFont1}>Поклажедатель</Text>
              <Item disabled>
                <Input disabled
                multiline={true}
                placeholder={this.state.deal.bailor.firstname+ ' '+ this.state.deal.bailor.lastname}  />
                  <IconNB name="ios-information-circle" />
              </Item>

              <Text style={styles.myFont1}>Вещь, передаваемая на хранение</Text>

                <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
                multiline={true}
                 onChangeText={(text) => this.deal(text, 'itemname')}
                defaultValue={this.state.deal.itemname}
                placeholder={this.state.deal.itemname}  />


                   <Text style={styles.myFont1}>Срок хранения</Text>
                   <Item disabled regular={!this.state.isRegular}>
                     <Input disabled
                     multiline={true}

                     placeholder={this.dateFormat(this.state.deal.shelfdate)}  />
                     {(this.state.toChange)?(
                                 <DatePicker
                          ...
                          onDateChange={(date) => {this.setState({shelfdate: date})}}
                         />
                       ):(<Text></Text>)}
                           </Item>


              <Text style={styles.myFont1}>Вознаграждение и возмещение расходов хранителю</Text>

                <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
                multiline={true}
                onChangeText={(text) => this.deal(text, 'awardamount')}
              ...
              <Text style={styles.myFont1}>Ответственность за несохранность</Text>

                <TextInput style={[ !this.state.isRegular? styles.myInputBorder : styles.myInput]} numberOfLines = {3} editable={!this.state.isRegular}
                multiline={true}
                onChangeText={(text) => this.deal(text, 'responsibility')}
                defaultValue={this.state.deal.responsibility}
                placeholder={this.state.deal.responsibility}  />
        ...
        {(Object.keys(this.state.olddeal).length != 0)?(
            ...
            <Item disabled>
              <Input disabled
              multiline={true}
              placeholder={this.state.olddeal.keeper.firstname+ ' '+ this.state.olddeal.keeper.lastname}  />
            </Item>
            <Text style={styles.myFont1}>Поклажедатель</Text>
            <Item disabled>
              <Input disabled
              multiline={true}
              placeholder={this.state.olddeal.bailor.firstname+ ' '+ this.state.olddeal.bailor.lastname}  />
            ...
            <Item disabled regular={!this.state.isRegular}>
              <Input disabled
              multiline={true}
              defaultValue={this.state.olddeal.shelfdate}
              placeholder={this.dateFormat(this.state.olddeal.shelfdate)}  />
            {objKeys.includes("itemname")? <IconNB name="md-create" />:<Text></Text>}
            </Item>
            <Text style={styles.myFont1}>Вознаграждение и возмещение расходов хранителю</Text>
            <Item  disabled regular={!this.state.isRegular}>
              ...
              placeholder={this.state.olddeal.awardamount}  />
            {objKeys.includes("itemname")? <IconNB name="md-create" />:<Text></Text>}
            </Item>
            <Text style={styles.myFont1}>Сроки и порядок оплаты</Text>
            <Item  disabled regular={!this.state.isRegular}>
            ...
            <Item  disabled regular={!this.state.isRegular}>
              <Input disabled
              multiline={true}
              defaultValue={this.state.olddeal.responsibility}
              placeholder={this.state.olddeal.responsibility}  />
            {objKeys.includes("itemname")? <IconNB name="md-create" />:<Text></Text>}
            </Item>
            <Text style={styles.myFont1}>Срок действия договора</Text>
            <Item disabled regular={!this.state.isRegular}>
